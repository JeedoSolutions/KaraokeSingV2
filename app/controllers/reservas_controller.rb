class ReservasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @reserva.save
        format.html { redirect_to @reserva, notice: 'Reserva fue creado con éxito.' }
  ...
  def update
    ...
    respond_to do |format|
      if @reserva.update(reserva_params)
        format.html { redirect_to @reserva, notice: 'Reserva fue actualizado con éxito.' }
  ...
  def destroy
    ...
    @reserva.destroy
    respond_to do |format|
      format.html { redirect_to reservas_url, notice: 'Reserva fue eliminado con éxito.' }
